            ...
            <div class="container mt-5">
                ...
                <div class="card" id="formContainer">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="border rounded p-3 h-100">
                                    ...
                                    <small class="text-muted">Leave empty for worldwide, or specify countries separated
                                        by
                                        commas</small>
                                </div>
                            </div>
                    ...
                    <div class="form-section p-4 mb-4" id="step5">
                        ...
                        <p class="text-muted text-center mb-4">Optional features to increase visibility and attract top
                            talent</p>
                        ...
                        <div class="border rounded p-3 mb-3 d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <small class="text-muted d-block mb-2">Increase visibility with premium placement in
                                    search
                                    results</small>
                            ...
                            <div class="text-end">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input boost-option" type="checkbox" value="49"
                                        data-label="Sponsored Posting">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="border rounded p-3 mb-3 d-flex justify-content-between align-items-center">
                            ...
                            <div class="text-end">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input boost-option" type="checkbox" value="29"
                                        data-label="Highlighted Posting">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="border rounded p-3 mb-3 d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <small class="text-muted d-block mb-2">Get featured in our weekly newsletter and social
                                    media</small>
                            ...
                            <div class="text-end">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input boost-option" type="checkbox" value="19"
                                        data-label="Featured Posting">
                                </div>
                            </div>
                        </div>
