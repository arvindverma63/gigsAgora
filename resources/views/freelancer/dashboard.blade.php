...
<body>
    ...
    <div class="container my-4 job-container">
        <div class="card p-3 shadow-sm">
            <div class="row">
                <!-- Left Column: Title & Description -->
                <div class="col-md-9">
                    <h6 class="fw-bold text-primary mb-1">
                        Modify Software delete callback for Secure Offline Usage
                    </h6>
                    ...
                    <p class="text-muted small mb-2">
                        ...
                        Callback) Project Summary: We’re seeking a highly skilled and ethical software developer to
                        modify an existing desktop application that currently performs an automatic internet callback on
                        launch. When the software doesn't receive a response from the callback... <a href="#"
                    ...
                    <div class="d-flex align-items-center flex-wrap small text-muted">
                        ...
                        <span class="me-3 text-danger" style="font-size: 14px;"><i class="fa-solid fa-comment-dots"></i> 11</span>
                ...
                <div class="col-md-3 text-md-end text-start mt-3 mt-md-0">
                    ...
                    <p class="mb-0 fw-bold text-dark">
                        <span class="fs-5 text-success">$437</span> USD<br>
                        <span class="small text-muted">average bid</span>
                    </p>
                    <div class="mt-2">
                        <i class="fa-regular fa-heart text-muted"></i>
                    </div>
                    <button type="button" class="btn btn-primary mt-4"><i class="fa-regular fa-circle-check" style="font-size: 22px; vertical-align: middle;"></i> Apply</button>
                </div>
            </div>
        </div>
    </div>
